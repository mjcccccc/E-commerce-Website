...
if(isset($_POST['search'])){
  ...
  $stmt1 =  $conn->prepare("SELECT COUNT(*) AS total_records FROM products WHERE product_category LIKE ? AND product_price <= ?");
  ...
  //4. get all products
  $stmt2 = $conn->prepare("SELECT * FROM products WHERE product_category LIKE ? AND product_price <= ? LIMIT $offset, $total_records_per_page");
...
?>
    ...
    <div class="d-flex justify-content-between">
        ...
        <form action="mall.php" method="POST">
          <div class="row mx-auto container">
            <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              <div class="form-check">
                <input class="form-check-input" value="Appliances" type="radio" name="category" id="category_two" <?php if(isset($category) && $category=='%Appliances%'){echo 'checked';}?>>
                <label class="form-check-label" for="flexRadioDefault2">
                  Appliances
                </label>
              </div>
              ...
              <div class="form-check">
                <input class="form-check-input" value="Gadgets" type="radio" name="category" id="category_two" <?php if(isset($category)&& $category=='%Gadgets%'){echo 'checked';}?>>
                <label class="form-check-label" for="flexRadioDefault2">
                  Gadgets
                </label>
              </div>
      ...
      <section id="shop" class="mt-5 pt-5">
        <div class="container mt-3 py-3">
          <h2>| The Mall</h2>
          <p class="mx-3">Limited time offer - grab yours now!</p>
        </div>
        <div class="row mx-auto container">
