...
if(isset($_POST['add_to_cart'])){
    ...
    // Uncomment the line below if you have a specific redirection page
      ...
      <table class="mt-5 pt-5">
        ...
        <?php if (isset($_SESSION['cart'])){ ?>
          ...
          <tr>
            ...
            <td>
              <span>$</span><span class="product-price"><?php echo $value['product_quantity'] * $value['product_price']; ?></span>
            </td>
          </tr>
